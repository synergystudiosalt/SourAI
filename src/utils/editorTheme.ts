...
const lightTheme = createTheme({
  ...
  styles: [
    ...
    { tag: [t.variableName], color: '#232a3d' },
...
const darkTheme = createTheme({
  ...
  settings: {
    ...
    caret: '#7aa2f7',
    selection: '#283457',
    selectionMatch: '#1f2947',
    lineHighlight: '#161c2ccc',
    gutterBackground: '#10141f',
    gutterForeground: '#4a5578',
  ...
  styles: [
    ...
    { tag: [t.definition(t.variableName), t.definition(t.propertyName)], color: '#c0caf5', fontWeight: '600' },
